/**
 * @项目名称: generator-web
 * @文件名称: HuaxiaTableMyBatis3Impl 版本号：1.0
 * @创建日期: 2017年10月10日 11:16
 * <p>
 ...
 * @version
 */
public class HuaxiaTableMyBatis3Impl extends HuaxiaIntrospectedTable {
     ...
     */
    public HuaxiaTableMyBatis3Impl() {
    ...
    protected void calculateXmlMapperGenerator(AbstractJavaClientGenerator javaClientGenerator,
        ...
        if (javaClientGenerator == null) {
            if (context.getSqlMapGeneratorConfiguration() != null) {
                xmlMapperGenerator = new HuaxiaXMLMapperGenerator();
            }
        } else {
