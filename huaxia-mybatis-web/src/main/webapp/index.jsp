    ...
    <div class="navbar navbar-default navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Mybatis在线生成器</a>
        </div>
	...
	<div class="container login-form">
		<form class="form-horizontal" role="form" id="form">
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="192.168.11.228" id="connection" name="connection" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-xs-4">
					<input type="password" placeholder="password" id="userPass" name="userPass" class="form-control" required/>
				</div>
			</div>

			<div class="form-group">
				<label for="servicePath" class="col-lg-2 control-label">service的包名路径</label>
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="com.huaxia.demo.api.service" id="servicePath" name="servicePath" required/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="com.huaxia.demo.model" id="modelPath" name="modelPath" required/>
				</div>
			</div>
			...
			<%--<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="com.huaxia.demo.dao" id="daoPath" name="daoPath" required/>
				</div>
			</div>--%>
			...
			<div class="form-group">
				...
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="com.huaxia.demo.mapper" id="mappingPath" name="mappingPath" required/>
				</div>
			</div>

			<div id="humpPath" class="form-group">
				<label for="humpPath" class="col-lg-2 control-label">模型是否驼峰命名</label>
				<div class="col-lg-10">
			...
			<div class="form-group">
				<label for="singleRadio" class="col-lg-2 control-label">生成方式</label>
				<div class="col-lg-10">
					<label class="radio-inline">
						<input type="radio" name="optionsRadiosinline" id="singleRadio" value="0" checked> 逐表增加
					</label>
					<label class="radio-inline">
						<input type="radio" name="optionsRadiosinline" id="batchRadio"  value="1"> 批量生成
					</label>
				</div>
			</div>


			<div id="tablePrefix" class="form-group">
				<label for="prefix" class="col-lg-2 control-label">表前缀</label>
				<div class="col-lg-10">
					<input type="text" class="form-control" placeholder="类似t_，包含分隔符" id="prefix" name="prefix" />
				</div>
			</div>
