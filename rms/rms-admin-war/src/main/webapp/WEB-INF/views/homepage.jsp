            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${ctx }/resources/adminlte/dist/img/user3-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="${ctx }/resources/adminlte/dist/img/user4-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="${ctx }/resources/adminlte/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">${user.name}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="${ctx }/resources/adminlte/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="logout.jhtml" class="btn btn-default btn-flat">Sign out</a>
                                </div>
                            </li>
                        </ul>
                    </li>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        App.setbasePath("../");
        App.setGlobalImgPath("${ctx }resources/adminlte/dist/img/");
        ...
        //加载菜单数据
        var resData;
        ajaxPost(basePath+"/res/userres",null,function(data){
            resData = "[" + data + "]";
        });
        //resData = menus;
        console.log("#############resData: "+ resData);
        $('.sidebar-menu').sidebarMenu({data: eval(resData)});
