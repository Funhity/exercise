                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <label class="control-label">
                                    <input type="radio" name="restype" class="square-green" checked="checked"	value="0"> 系統
                                </label> &nbsp;&nbsp;&nbsp;
                                <label class="control-label">
                                    <input type="radio" name="restype" class="square-green" checked="checked"	value="1"> 目录
                                </label> &nbsp;&nbsp;&nbsp;
                                <label class="control-label">
