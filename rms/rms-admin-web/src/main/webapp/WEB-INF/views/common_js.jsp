...
<!-- dataTable -->
<script src="${ctx}/static/adminlte/plugins/datatables/jquery.dataTables.js"></script>
...
<!-- treeview -->
<script src="${ctx}/static/adminlte/plugins/bootstrap-treeview/bootstrap-treeview.min.js"></script>

<!-- AdminLTE for demo purposes -->
<script src="${ctx}/static/adminlte/dist/js/demo.js"></script>
<!--select2-->
<script src="${ctx}/static/adminlte/plugins/select2/select2.full.min.js"></script>
<%--<script src="${ctx}/static/adminlte/plugins/select2/select2.full.js"></script>--%>

<script src="${ctx}/static/adminlte/plugins/ie9/respond.min.js"></script>
<script src="${ctx}/static/adminlte/plugins/ie9/html5shiv.min.js"></script>
...
<script type="text/javascript" src="${ctx}/static/common/js/base-role.js"></script>
<script type="text/javascript" src="${ctx}/static/common/js/base-category.js"></script>

<script type="text/javascript" src="${ctx}/static/common/js/app_iframe.js"></script>

<%--<script type="text/javascript" src="${ctx}/static/common/js/select2/select2.full.min.js"></script>--%>
<%--<script type="text/javascript" src="${ctx}/static/common/js/select2/i18n/zh-CN.js"></script>--%>
<%--<script type="text/javascript" src="${ctx}/static/common/js/select2/select2.min.js"></script>--%>
<%--<script type="text/javascript" src="${ctx}/static/common/js/bootstrap-tab.js"></script>--%>
