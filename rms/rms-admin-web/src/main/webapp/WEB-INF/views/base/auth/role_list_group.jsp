            ...
            <div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="dataTables_filter" id="searchRolesDiv" style="padding-bottom: 6px;">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" data-btn-type="addRoot">新增根节点</button>
                                    <button type="button" class="btn btn-default" data-btn-type="addGroup">新增</button>
                                    <button type="button" class="btn btn-default" data-btn-type="editGroup" >编辑</button>
                                    <button type="button" class="btn btn-default" data-btn-type="deleteGroup">删除</button>
                                </div>
                            </div>
                            <div id="tree"></div>
                        </div>
