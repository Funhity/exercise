    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                ...
                <div class="dataTables_filter" id="searchDiv_unselected">
                    ...
                    <input placeholder="请输入用户名" name="realname" class="form-control form-control-sm" type="search" />
                    <div class="btn-group">
                        <button type="button" class="btn btn-primary" data-btn-type="search" >查询</button>
                    </div>
                </div>
                <div class="box-body">
                    <table id="userRole_unselected_table" class="table table-bordered table-striped table-hover" style="font-size:13px; ">
                    </table>
                </div>
                <!-- /.box-body -->
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table id="userRole_selected_table" class="table table-bordered table-striped table-hover" style="font-size:13px; ">
                    </table>
                </div>
                <!-- /.box-body -->
            </div>
