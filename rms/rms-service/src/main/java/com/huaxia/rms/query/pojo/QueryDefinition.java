package com.huaxia.rms.query.pojo;

import com.huaxia.rms.query.entity.Query;
import com.huaxia.rms.query.entity.QueryContext;
import com.huaxia.rms.utils.ConfigurationUtil;
...
public class QueryDefinition {
    ...
    private static Logger log = LoggerFactory.getLogger(QueryDefinition.class);

    public static final String DEFAULT_CONFIG_LOCATION = "META-INF/query/*.xml";
