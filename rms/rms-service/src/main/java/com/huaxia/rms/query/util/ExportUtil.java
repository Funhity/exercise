...
public class ExportUtil {
     ...
     */
    public static void writeTitle(QueryCondition queryCondition, Query query, WritableSheet sheet) throws Exception {
        try {
            //写标题
            ...
            if (lastCol == -1) {
                throw new Exception(query.getId() + "的xml未配置任何可导出的列，请检查");
            }
            ...
            throw new Exception("写入标题时候发生异常：异常信息为：" + ex.getMessage());
        }
     ...
     * @throws Exception 执行异常
     */
    public static void writeHeader(QueryCondition queryCondition, Query query, WritableSheet sheet) throws Exception {
        ...
        try {
            ...
            throw new Exception("写入数据表头发生异常，异常信息：" + ex.getMessage());
        }
     ...
     * @throws Exception 执行异常
     */
    public static void writeData(QueryCondition queryCondition, Query query, WritableSheet sheet, List objList, Class objClass) throws Exception {
        int headIndex = getTitleIndex(queryCondition);
        try {
     ...
     */
    private static String getCellStringData(Class objClass, Object obj, Column column) throws Exception {
        try {
            String data = null;
            if (objClass != null) {
            ...
            throw new Exception("单元格数据转换方法getCellStringData错误，错误信息：" + ex.getMessage());
        }
    }
     ...
     * @throws Exception
     */
    public static void executeSheetMethod(QueryCondition queryCondition,WritableSheet sheet) throws Exception {
        try {
            ...
            throw new Exception("执行rowSpan方法异常，异常信息："+ex.getMessage());
        }
