...
public class RgValidateCodeCheckAuthenticationHandlerImpl implements AuthenticationHandler {
...
//        Object memValidateCode = redisTemplate.opsForValue().get(Constants.REDIS_REGIST_PWD_VALIDATE_CODE_KEY+userInfo.getName());
        Object memValidateCode = new Object();
        String key = Constants.REDIS_REGIST_PWD_VALIDATE_CODE_KEY + userInfo.getName();
...
//        }
        ...
        redisTemplate.delete(Constants.REDIS_REGIST_PWD_VALIDATE_CODE_KEY+userInfo.getName());
