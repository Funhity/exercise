...
public class RegistValidateCodeCheckAuthenticationHandlerImpl implements AuthenticationHandler {
...
//        Object memValidateCode = redisTemplate.opsForValue().get(Constants.REDIS_REGIST_VALIDATE_CODE_KEY+userInfo.getName());
        Object memValidateCode = new Object();
        String key = Constants.REDIS_REGIST_VALIDATE_CODE_KEY + userInfo.getName();
        ...
        if(StringUtils.isNotBlank(testValidateCode)) {
...
//        if(!StringUtils.equalsIgnoreCase((String)memValidateCode, userInfo.getValidateCode())) {
...
//        }
        ...
        redisTemplate.delete(Constants.MEMCACHE_REGIST_VALIDATE_CODE_KEY+userInfo.getName());
    }
