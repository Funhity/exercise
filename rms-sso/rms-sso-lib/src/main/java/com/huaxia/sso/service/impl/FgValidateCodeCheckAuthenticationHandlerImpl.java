...
public class FgValidateCodeCheckAuthenticationHandlerImpl implements AuthenticationHandler {
...
//        }
        ...
        redisTemplate.delete(Constants.REDIS_FP_LOGIN_VALIDATE_CODE_KEY+userInfo.getName());
    }
